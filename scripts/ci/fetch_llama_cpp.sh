...
for patch_file in "$patch_dir"/ggml-vulkan-skip-mmvq.patch "$patch_dir"/ggml-vulkan-clamp-warptile.patch "$patch_dir"/ggml-vulkan-instance-init-diag.patch "$patch_dir"/ggml-opencl-reg-diag.patch; do
