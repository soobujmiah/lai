...
**Machine-generated operational state:** see [`.repo/STATUS.md`](./.repo/STATUS.md) (generated by `tools/repo_knowledge`). For cross-project SKB registry state, see [`projects/registry/lai.json`](../../projects/registry/lai.json) in the parent SKB repository.
<!-- deterministic-state-bridge: lai -->
