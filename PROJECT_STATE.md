...
3. **Adreno OpenCL track — closed, low priority, not an open investigation.** The app-launch hang
   ...
   not fixed: `qwen2.5-1.5b-instruct-q4-k-m`'s catalog id (hyphens) doesn't match the workspace
   auto-importer's filename-derived id for the same file (`q4_k_m`, underscore).
